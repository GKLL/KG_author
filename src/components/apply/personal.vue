      ...
      <div class="box">
        ...
        <el-form ref="form" :model="form"  :rules="rules" label-width="115px" label-position="left">
          <el-form-item label="专栏名称："  class="name" prop="name" >
            <el-input  v-model="form.name" placeholder="2-15个字，支持中英文、数字，不包含特殊符号、空格，不区分大小写"></el-input>
          </el-form-item>
          <el-form-item label="专栏介绍："  class="introduce" prop="region" >
          <el-input v-model="form.region" type="textarea" :rows="4" placeholder="10-50个字，支持中英文、数字、符号、空格，不区分大小写"></el-input>
          </el-form-item>
          ...
          <el-form-item :label=" personalVisible? '身份证号：':'身份证号：'" prop="ID">
            <el-input v-model="form.ID"  class="el-input"></el-input>
          </el-form-item>
        ...
        <div class="mask-title">千氪专栏申请协议</div>
         <div class="mask-block2">
          ...
          <p>
           ...
           <p>
             6.3 您理解并且同意，为持续改善字节跳动为您提供的各项服务，您授予千氪网络公司及其关联方、合作方对您上传发布的任何内容具有全世界范围内的、永久的、不可撤销的、免费的、非独家的使用权。
           </p>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      rules: {
        name: [
          { required: true, validator: validateColumnName, trigger: "change" }
        ],
        region: [
          { required: true, message: "请填写专栏介绍", trigger: "change" },
          {
            min: 10,
            max: 50,
        ...
        cards: [{ required: true, validator: validateCards, trigger: "blur" }],
        //媒体
        companyName: [
