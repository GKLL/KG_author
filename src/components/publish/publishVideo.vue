      ...
      <el-row>
        <el-col :span="24">
          <el-form ref="form" :model="form" :rules="rules">
            ...
            <el-form-item class = 'marginTop' label="Tag标签：" prop = 'tag' label-width="102px">
            ...
            <el-form-item label="视频简介：" label-width="102px" prop="textarea" class="area">
            ...
            <el-form-item label="封面图：" label-width="102px" prop = "listCoverImgPost">
              <div class="articleImg">
                <div class="img" v-loading="imgloading">
                  <img v-if = "form.listCoverImgPost == null " class = ' listCoverImg' src = "https://pro-kg-oss.oss-cn-beijing.aliyuncs.com/author/img/articleDefaut.png" />
            ...
            <div v-if = "form.articleType === '' ? false : true">
              <el-form-item  v-if = "form.articleType == 1 ? false : true" label="视频来源：" prop = "articleSource" label-width="102px">
                <el-input size = 'small' v-model="form.articleSource" placeholder = '请输入'></el-input>
              </el-form-item>
              <el-form-item  v-if = "form.articleType == 1 ? false : true" label="原文链接：" prop = "articleLink" label-width="102px">
                <el-input size = 'small' v-model="form.articleLink" placeholder = '请输入'></el-input>
              </el-form-item>
            </div>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      imgUrl: C.imgHost,
      tutorial: C.mainNameHost+'/tutorial',  //如何上传视频链接地址
  ...
  methods: {
    ...
    preview() {
      if(this.form.videoType === '1') {
        ...
        localStorage.setItem('videoUrl',this.form.videoInfo)
      }else {
        localStorage.setItem('videoFilename','')
        localStorage.setItem('videoUrl',this.form.videoInfo2)
      }
