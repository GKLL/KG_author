        ...
        <el-row>
          <el-col :span="24">
            <el-form ref="form" :model="form" class="articleForm" :rules="rules">
              ...
              <el-form-item label="文章摘要：" prop = 'textarea' label-width="102px">
                <el-input
                  size = "small"
                  type="textarea"
                  placeholder="请输入文章摘要"
              ...
              <div v-if = "form.articleType === '' ? false : true">
                <el-form-item  v-if = "form.articleType == 1 ? false : true" label="文章来源：" prop = "articleSource" label-width="102px">
                  <el-input size = 'small' v-model="form.articleSource" placeholder = '请输入' @change = "autoSave"></el-input>
                </el-form-item>
                <el-form-item  v-if = "form.articleType == 1 ? false : true" label="原文链接：" prop = "articleLink" label-width="102px">
                  <el-input size = 'small' v-model="form.articleLink" placeholder = '请输入' @change = "autoSave"></el-input>
                </el-form-item>
              </div>
