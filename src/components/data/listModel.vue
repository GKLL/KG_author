      ...
      <el-col :span="24" :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="content" v-if="list.length!=0" v-for="(item,index) in list" :key="index" v-loading="loading">
        <div class="headImg" >
          <div style="position: relative">
            ...
            <img v-if="item.realAuthedTag==1" src="https://pro-kg-oss.oss-cn-beijing.aliyuncs.com/author/img/v2.png" style="position: absolute;right: 4px;top: 50px;width: 12px;height: 12px;border-radius: 50%;overflow: hidden"></img>
            <img v-if="item.vipTag==1" src="https://pro-kg-oss.oss-cn-beijing.aliyuncs.com/author/img/v2.png" style="position: absolute;right: 4px;top: 50px;width: 12px;height: 12px;border-radius: 50%;overflow: hidden"></img>
          </div>
        </div>
        <div class="name">
          <div class="name-title">
            <span class="name-title-first">{{item.name}}</span>
            <span  class="name-title-last" v-if="item.vipTag==1">{{item.identityTag}}</span>
