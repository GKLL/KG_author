      ...
      var o = {
        ...
        /*  trigger: 'axis',// 触发类型 这个时条形图和折线图的
          ...
          formatter: function (params) {
            return `<div>${params.name}</div><span style="width: 5px;height: 5px;border-radius:50%;margin-right: 5px;background-color: #2382EA;display: inline-block"></span><span>新增粉丝：</span><span>${params.value}</span>`
          }
        },
        grid: {
          left: '3%',
