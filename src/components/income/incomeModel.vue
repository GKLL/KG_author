...
<template>
  <div class="incomeModel">
   <!-- <el-row type="flex"  justify="end">
      <el-col :span="24">
        <div class="cold">冻结钛值   {{freeze}}TV</div>
      </el-col>
    </el-row>-->
    ...
    <el-row   class="detail" >
        ...
        <el-row type="flex"  justify="space-around" align="middle" class="detail-head">
          ...
          <el-col :span="4" >
            <div class="detail-head-tip ">
                <span class="re">广告收益（TV）<i class="iconfont icon-if__QuestionMark_  detail-head-question" >
               <div class="detail-head-content">
                      文章中投放广告即可获取收益，
                  功能将于近期上线
                </div>
      ...
      <el-col :span="24" :xs="24" :sm="24" :md="24" :lg="24" :xl="24" v-loading="loading">
        ...
        <el-row class="no-list"  v-if="list.length==1">
      ...
      <!-- <el-col :span="24" :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
         <el-table
           v-loading="loading"
           :data="list"
           :default-sort = "{prop: 'date_time', order: 'descending'}"
    ...
    >
      ...
      <div class="diaboss">
        ...
        <div class="ten">
          ...
          <div class="ten-first">
            <div class="inline  re">
              <img class="touxiang"  v-if="orderBy.length!=0&&orderBy[1].column_avatar"  :src=orderBy[1].column_avatar alt="" >
              <img class="silver"  src="https://pro-kg-oss.oss-cn-beijing.aliyuncs.com/author/Benefit-analysis/no2@3x.png" alt="" >
              <p class="title" v-if="orderBy.length!=0&&orderBy[1].column_name">{{orderBy[1].column_name}}</p>
              <p class="red" v-if="orderBy.length!=0&&orderBy[1].total_sum">{{orderBy[1].total_sum}}TV</p>
            </div>
            <div class="inline  re">
              <img class="gold"  v-if="orderBy.length!=0&&orderBy[0].column_avatar"  :src=orderBy[0].column_avatar alt="" >
              <img class="gold-ab" src="https://pro-kg-oss.oss-cn-beijing.aliyuncs.com/author/Benefit-analysis/no1@3x.png" alt="" >
              <p class="title" v-if="orderBy.length!=0&&orderBy[0].column_name">{{orderBy[0].column_name}}</p>
              <p class="red" v-if="orderBy.length!=0&&orderBy[0].total_sum">{{orderBy[0].total_sum}}TV</p>
            </div>
            <div class="inline  re">
              <img class="touxiang"  v-if="orderBy.length!=0&&orderBy[2].column_avatar"  :src=orderBy[2].column_avatar alt="" >
              <img class="silver"  src="https://pro-kg-oss.oss-cn-beijing.aliyuncs.com/author/Benefit-analysis/no3@3x.png" alt="" >
              <p class="title" v-if="orderBy.length!=0&&orderBy[2].column_name">{{orderBy[2].column_name}}</p>
              <p class="red" v-if="orderBy.length!=0&&orderBy[2].total_sum">{{orderBy[2].total_sum}}TV</p>
            </div>
          </div>
          <!--4-10-->
          <div class="four" v-if="fourTen.length!=0" v-for="(item,index) in fourTen" :key="index">
            ...
            <img v-if="index==6" class="first-img" src="https://pro-kg-oss.oss-cn-beijing.aliyuncs.com/author/Benefit-analysis/10@3x.png" alt="">
            <img class="touxiang" :src=item.column_avatar alt="" >
            <span class="left">{{item.column_name}}</span>
            <span class="last-span">{{item.total_sum}}</span>
          </div>
        </div>
        <div class="strategy">
          <div class="title">
          ...
          <div class="content">
            <div class="sanguo">
              <img src="https://pro-kg-oss.oss-cn-beijing.aliyuncs.com/author/Benefit-analysis/left@3x.png" alt="">
              <img src="https://pro-kg-oss.oss-cn-beijing.aliyuncs.com/author/Benefit-analysis/one@3x.png" alt="">
              <img src="https://pro-kg-oss.oss-cn-beijing.aliyuncs.com/author/Benefit-analysis/right@3x.png" alt="">
            </div>
            <p >发文审核通过可获得基础奖励</p>
            <div class="sanguo">
              <img src="https://pro-kg-oss.oss-cn-beijing.aliyuncs.com/author/Benefit-analysis/left@3x.png" alt="">
              <img src="https://pro-kg-oss.oss-cn-beijing.aliyuncs.com/author/Benefit-analysis/two@3x.png" alt="">
              <img src="https://pro-kg-oss.oss-cn-beijing.aliyuncs.com/author/Benefit-analysis/right@3x.png" alt="">
            </div>
...
<div><span style="width: 5px;height: 5px;border-radius:50%;margin-right: 5px;background-color: #2382EA;display: inline-block"></span><span style="color: black">打赏收益：</span><span style="color: black">${params[0].give_award_earning}</span></div>
    ...
    .diaboss{
      ...
      .strategy{
        ...
        .title{
          ...
          height: 52px;
          border-radius: 26px;
          background: linear-gradient(#6683FB, #62A0FF);
          position: absolute;
          top: -26px;
          right: 120px;
          img{
